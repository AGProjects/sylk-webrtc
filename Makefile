...
deploy: dist
	...
	rsync -av --exclude .htaccess --exclude .well-known --delete dist/ -e 'ssh -A -J agp@ca-node02.dns-hosting.info:22' agp@10.208.120.103:/var/www/webrtc/
	ssh -A -J agp@ca-node02.dns-hosting.info:22 agp@10.208.120.103 'sudo /root/sync-webrtc.sh'
